...
{
    public class ArticleControllerOLD : Controller
    {
        private IConfiguration _configuration;

        public ArticleControllerOLD(IConfiguration Configuration)
        {
        ...
        public IActionResult Create(Article article)
        {
            ...
            ArticleHandlerOLD handler = new ArticleHandlerOLD(_configuration);
